...
class AppLocalizations {
  ...
  static const Map<String, String> _ar = {
    ...
    'noLoansFound': 'لا توجد أقساط مسجلة بهذه البيانات',
    'firebaseError': 'خطأ في الاتصال بالسيرفر — تأكد من اتصال الإنترنت',
    ...
    'notes': 'ملاحظات',
    'pickIdImage': 'صورة البطاقة',
    'camera': 'الكاميرا',
    'gallery': 'المعرض',
    'addIdImage': 'إضافة صورة البطاقة',
    'idImageSelected': 'تم اختيار الصورة',
    'sendWhatsAppQuestion': 'هل تريد إرسال بيانات الدخول للعميل عبر واتساب؟',
  ...
  static const Map<String, String> _en = {
    ...
    'noLoansFound': 'No installments found for these credentials',
    'firebaseError': 'Server connection error — check your internet',
    ...
    'notes': 'Notes',
    'pickIdImage': 'ID Card Image',
    'camera': 'Camera',
    'gallery': 'Gallery',
    'addIdImage': 'Add ID Card Image',
    'idImageSelected': 'Image selected',
    'sendWhatsAppQuestion': 'Send login details to customer via WhatsApp?',
